...
mod audio_mouth_moving;
use audio_mouth_moving::AudioMouthMoving;

mod camera_reader; 
use camera_reader::CameraReader;

mod facial_detection;
use facial_detection::FacialDetection;

mod mouth_moving;
use mouth_moving::MouthMoving;

mod sound_reader;
use sound_reader::SoundReader;
